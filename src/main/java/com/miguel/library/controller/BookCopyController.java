...
public class BookCopyController {
    ...
    public ResponseEntity<BookResponseDTOBookCopy> saveNewBookCopy(
    ...
    @GetMapping("/get-edition-copies/{bookEditionId}")
    ...
    public ResponseEntity<BookResponseDTOBookCopy> editBookEdition(
